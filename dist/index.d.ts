...
} & Pick<FixedSizeListProps, "style" | "layout" | "className" | "itemSize" | "height" | "itemCount" | "width" | "direction" | "initialScrollOffset" | "itemKey" | "overscanCount" | "onItemsRendered" | "onScroll" | "innerElementType" | "innerRef" | "innerTagName" | "itemData" | "outerElementType" | "outerRef" | "outerTagName" | "useIsScrolling"> & React.RefAttributes<any>>;
